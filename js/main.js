const username = 'IceDoesJs';
const maxPages = 2;
const hideForks = true;
const repoList = document.querySelector('.repo-list');
const reposSection = document.querySelector('.repos');
const communityStats = document.querySelector('.server-stats')
...
const displayRepos = async(repos) => {
    ...
    for (const repo of repos) {
        ...
        let allowed_repo = await repoMatch(repo);
        ...
        if (allowed_repo) repoList.append(listItem);
    }
};
...
const devicons = {
    Member: '<i class="fa-solid fa-person"></i>',
    Online: '<i class="fa-solid fa-circle" style="color:#009E60"></i>',
